<template>
    <div id="NewReserv">
        <!-- Header -->
        <div class="flex bg-blue-800 items-center justify-between fixed w-full z-10">
            <div class="flex items-center justify-start md:justify-center pl-3 w-14 md:w-64 h-14 bg-blue-800 dark:bg-gray-800
        border-none">
                <img class="w-7 h-7 md:w-10 md:h-10 mr-2  rounded-md overflow-hidden"
                    src="https://i.imgur.com/OZaT7jl.png" />
                <span class="hidden md:block font-bold text-white">ADMIN</span>
            </div>

            <div class="bg-white rounded flex items-center w-full max-w-xl mr-4 p-2 shadow-sm border border-gray-200 h-10">
            ...
            <ul class="flex items-center">
                ...
                <li>
                    <a href="#" class="flex items-center font-bold mr-4 text-white text-white hover:text-emerald-950	">
                ...
                <ul class="flex flex-col py-4 space-y-1">
                    ...
                    <li>
                        <router-link to="/NewReserv"
                            ...
                            <span class="ml-2 text-sm tracking-wide truncate">New Reservation</span>
                            <span
                    ...
                    <li>
                        <a href="#"
                            ...
                            <span class="ml-2 text-sm tracking-wide truncate">Laundry</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span class="ml-2 text-sm tracking-wide truncate">SPA</span>
                            <span
                    ...
                    <div class="max-w-md mx-auto">
                        <div class="flex items-center space-x-5">
                            ...
                            <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
                                <h2 class="leading-relaxed">Create New Reservation</h2>
                        ...
                        <div class="divide-y divide-gray-200">
                            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex flex-col">
                                        ...
                                        <input type="date" name="date" id="date"
                                            class="w-full rounded-md border border-[#e0e0e0] bg-red py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                    </div>
                                    <div class="flex flex-col">
                                        <label for="date" class="mb-3 block text-base font-medium text-[#07074D]">
                                            Checkout Date
                                ...
                                <div class="flex flex-col">
                                    <label class="leading-loose">Type Room</label>
                                    <select
                                        class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                                        <option value="deluxe">Deluxe</option>
                                        <option value="standard">Standard</option>
                                        <option value="suite">Suite</option>
                                        <!-- Tambahkan lebih banyak elemen <option> sesuai kebutuhan -->
                                    </select>
                                </div>
                                <div class="flex flex-col">
                                    ...
                                    <select
                                        class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                                        <option value="deluxe">BCA</option>
                                        <option value="standard">BRI</option>
                                        <option value="suite">mandiri</option>
                                        <!-- Tambahkan lebih banyak elemen <option> sesuai kebutuhan -->
                                    </select>
                                </div>
